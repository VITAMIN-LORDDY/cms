<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <li><a class="navbar-brand" href="../index.php">HOME PAGE</li>
                <li class="dropdown">
                    <a href="#"  class="navbar-brand"data-toggle="dropdown"><i class="fa fa-user"></i> Vitamin Lorddy <b class="caret"></b></a>
